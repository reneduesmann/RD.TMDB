...
public sealed class AccountStateConverter : JsonConverter<AccountState>
{
    ...
    public override AccountState? Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
    {
        ...
        AccountState? accountState = JsonSerializer.Deserialize<AccountState>(@object.ToJsonString(), _newOptions);
